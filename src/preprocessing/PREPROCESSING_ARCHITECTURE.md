...
Typical runtime is CPU-bound (tens of minutes for 55 columns at 128 dims with SVD) and stays within the existing ≤64 GB RAM envelope because only one column is loaded at a time.
